...
filter1 = "Power" -- nick filter matches nick1 and nick2
filter2 = "Test" -- nick filter matches only nick1
filter3 = "Test Power" -- nick filter matches only nick1
filter4 = "Power Nice" -- nick filter matches neither nick1 nor nick2
filter5 = "" -- nick filter matches every component (also components with no nick)
----
